...
('blog',         1,            'ブログ',                           'ブログ画面用',                       5,           true,      true,       true,        false),
('wiki',         1,            'Wiki',                             'Wiki画面用',                         6,           true,      true,       true,        false),
('calendar',     1,            'カレンダー',                       'カレンダー画面用',                   7,           true,      true,       true,        false),
('event',        1,            'イベント情報',                     'イベント情報画面用',                 8,           true,      true,       true,        false),
...
('index', 'photo',   'main',            2,       'static_content',     1,            '',                   '',          '',        true,             0,                    now()),
('index', 'photo',    'main',            5,       'photo_main',          0,            '',                   '',        '',        false,            0,                    now()),
('index', 'photo',    'left',            5,       'photo_new',          0,            '',                   '',         '最新画像', true,            0,                    now()),
...
('default_menu', 1,            'O:8:"stdClass":10:{s:6:"menuId";s:9:"main_menu";s:4:"name";s:27:"メインメニュー設定";s:9:"limitUser";s:1:"0";s:10:"isHierMenu";s:1:"0";s:15:"useVerticalMenu";s:1:"0";s:12:"showSitename";s:1:"0";s:10:"showSearch";s:1:"1";s:12:"anotherColor";s:1:"1";s:9:"showLogin";s:1:"0";s:10:"showRegist";s:1:"0";}', now());
...
('', 2,     'ja',           'ようこそ「世界の動物」へ',   '<p>このサイトはＰＣ、スマートフォン、タブレットなどマルチデバイスに対応した画像ライブラリサイトです。<br />\r\n&nbsp;</p>\r\n',              false, '',                0, now());
